            ...
            <div class="col-md-12">
              ...
              <ul class="nav nav-tabs" id="example-tabs">
                  ...
                  <?php
                    ...
                    $idGrup = $this->session->userdata("grup");

                    $arrayAkses = $this->db->query("select * from grup where id ='$idGrup'")->result();

                    $akses = $arrayAkses[0]->akses;

                    $akses = explode(";",$akses);

                    if(in_array("1",$akses)){

                      echo '<li><a href="#add" data-toggle="tab">Tambah Artikel Baru</a></li>';
                      ...
                      <?php
...

                          {
                            ...
                            if($hakEditArtikel == '1'){
                              ...
                              $editArtikelHTML = '<a href="'.base_url().'dashboard/blog/edit_artikel/'.$r->id.'">
                            ...
                            if($hakDeleteArtikel == '1'){

                              $deleteArtikelHTML = '<a href="'.base_url().'dashboard/blog/delete_artikel/'.$r->id.'">
